    ...
    <section class="search">
        ...
        <div class="search__query-wrapper">
            <div class="search__query container">
                <span>Вы искали:</span>
                <span class="search__query-text"><?= get_search($_GET['search_text']) ?></span>
            </div>
        </div>
                    ...
                    <?php foreach ($posts as $post) : ?>
                        <article class="feed__post post post-<?= $post['icon_class'] ?>">
                            ...
                            <div class="post__main">
                                ...
                                <?php if (intval($post['content_type_id']) === 3) : ?>
                                    <div class="post-details__image-wrapper post-photo__image-wrapper">
                                        <img src="<?= $post['img'] ?>" alt="Фото от пользователя" width="760"
                                             height="507">
                                    </div>
                                <?php elseif (intval($post['content_type_id']) === 2) : ?>
                                ...
                                <?php elseif (intval($post['content_type_id']) === 5) : ?>
                                ...
                                <?php elseif (intval($post['content_type_id']) === 1) : ?>
                                ...
                                <?php elseif (intval($post['content_type_id']) === 4) : ?>
