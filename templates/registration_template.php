                ...
                <div class="form__text-inputs">
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <? if($errors['email']) {echo "form__input-section--error";} ?>">
                            <input class="registration__input form__input" id="registration-email" type="email" name="email" placeholder="Укажите эл.почту" value="<? if(isset($_POST['email'])) {print($_POST['email']);} ?>">
                    ...
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <? if($errors['login']) {echo "form__input-section--error";} ?>">
                            <input class="registration__input form__input" id="registration-login" type="text" name="login" placeholder="Укажите логин" value="<? if(isset($_POST['login'])) {print($_POST['login']);} ?>">
                            <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                            <div class="form__error-text">
                    ...
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <? if($errors['password']) {echo "form__input-section--error";} ?>">
                            <input class="registration__input form__input" id="registration-password" type="password" name="password" placeholder="Придумайте пароль" value="<? if(isset($_POST['password'])) {print($_POST['password']);}?>">
                            <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                            <div class="form__error-text">
                    ...
                    <div class="registration__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <? if($errors['password-repeat']) {echo "form__input-section--error";} ?>">
                            <input class="registration__input form__input" id="registration-password-repeat" type="password" name="password-repeat" placeholder="Повторите пароль" value="<? if(isset($_POST['password-repeat'])) {print($_POST['password-repeat']);} ?>">
                            <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                            <div class="form__error-text">
